        ...
        >
            ...
            <div className="container">
                <div className="text-center mb-16">
                    <Reveal>
                        <h2 className="section-title">{text("도입 프로세스", "Implementation Process")}</h2>
                    </Reveal>
                    <div className="divider-modern mx-auto w-24 mb-6" />
                    <Reveal>
                        <p className="section-subtitle">
                            {text("체계적인 단계별 도입으로 안정적인 운영을 보장합니다", "A structured, phased implementation ensures stable operations.")}
                        </p>
                    </Reveal>
                </div>
                ...
                <Reveal className="grid grid-cols-1 md:grid-cols-4 gap-6">
                    {[
                        { step: 1, title: text("요구사항 분석", "Requirements Analysis"), desc: text("고객의 생산 프로세스와 요구사항을 상세히 분석합니다", "Analyze production processes and requirements in detail") },
                        { step: 2, title: text("시스템 설계", "System Design"), desc: text("맞춤형 대시보드와 기능을 설계합니다", "Design tailored dashboards and functions") },
                        { step: 3, title: text("구현 및 테스트", "Implementation and Testing"), desc: text("시스템을 구현하고 철저히 테스트합니다", "Implement and thoroughly test the system") },
                        { step: 4, title: text("운영 및 지원", "Operations and Support"), desc: text("안정적인 운영을 위해 지속적으로 지원합니다", "Provide ongoing support for stable operations") },
                    ].map((item) => (
